const ContactUs = () => {
    ...
    <>
        ...
        <form action="mailto:rapidato@cms.hhs.gov" method="post" enctype="text/plain">
            ...
            <label for="comment">Please enter your questions, comments, or feedback and we will be in touch soon</label>
            <input type="textarea" id="comment" name="comment" required /><br />
