...
const Breadcrumbs = () => {
    ...
    const topLevelList = ["help", "projects", "project-setup", "component-library"];
    ...
    if(pathname === ""){
        ...
        return (
            <BreadcrumbBar>
                ...
                <Breadcrumb current>{pathname}</Breadcrumb>
            </BreadcrumbBar>
        );
    }
    let parentList = [];
    ...
    if(pathname === "contact-us" || pathname === "faq"){
        ...
        if(pathArray.length === 3){
            parentList.push({title:"Confirmation", url:"/project-setup/confirmation"});
        }
